                                ...
                                <div className='flex-1 flex items-center justify-center md:justify-start'>
                                    <div className='flex-shrink-0 flex items-center'>
                                        <div className='h-10 w-10 mr-2 p-1'>
                                            <img src={RocketLaunchIcon} className='object-contain' alt='Stocker Logo' />
                                        </div>
                                        <span className='hidden lg:block mx-3 text-xl w-auto dark:text-white select-none'>Stocker</span>
                                    </div>
